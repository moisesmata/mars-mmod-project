// ======================================================================
// \title  MarsDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef MARSDEPLOYMENT_MARSDEPLOYMENTTOPOLOGY_HPP
#define MARSDEPLOYMENT_MARSDEPLOYMENTTOPOLOGY_HPP
// Included for access to MarsDeployment::TopologyState and MarsDeployment::ConfigObjects::pingEntries. These definitions are required by the
 ...
 * MarsDeployment::TopologyState see: MarsDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Mars::TopologyState see: MarsTopologyDefs.hpp.
 *
